...
const TodoCard = ({title,description,date}) => {
  return (
    <div className="w-full px-5 py-2 my-1 ">
      <div className="w-full min-h-24 rounded-md border-[0.5px] border-neutral-200 bg-white dark:bg-slate-800 dark:border-slate-500 dark:text-teal-100 shadow-md  scale-100 hover:scale-[98%]  hover:cursor-pointer hover:duration-150 duration-150  hover:shadow-lg ">
